...
class OnlineLeaveword extends BaseController
{
	...
	public function leavewordAdd(){
		
		return $this->logicOnlineLeaveword->leavewordAdd($this->param);
	}
	
	public function leavewordDel(){
		
		return $this->logicOnlineLeaveword->leavewordDel(['id'=>$this->param['id'],'uid'=>$this->param['uid']]);
	}
